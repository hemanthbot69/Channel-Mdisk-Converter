...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Hemanth:Hemanth@cluster0.qyj0a.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001781164734")) if os.environ.get("CHANNEL_ID") else []
